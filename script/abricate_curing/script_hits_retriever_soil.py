...
"""
#### SCRIPT DATABASE COMPARISON OF ARGs DETECTION IN GMGC soil CATALOG ####

# First, a list of the GMGC soil catalog genes is made
i_soil = "C:/Users/remi.gschwind/Desktop/Resfinder FG/ResFinder_FG_Analysis/analysis0422/data/subcatalogs_GMGC10.soil.95nr.fna"

soil_gene = []
with open(i_soil , 'r') as f :
    for line in f :
        if ">" in line :
            soil_gene.append(line.strip().split(">")[1])
...
o_rfg_soil = "C:/Users/remi.gschwind/Desktop/Resfinder FG/ResFinder_FG_Analysis/analysis0422/output/rfg_soil.csv"
...
# ARGs found in soil_gene list and in abricate results file are pooled in a list with :
...
with open(i_rfg , 'r') as f :
 	for line in f :
         if "resfinderfg" in line :
             ...
             rfg_soil.append(line.strip())
             if line.strip().split("	")[10] in soil_gene :
                 print(gene , (x/y)*100)
...
with open(o_rfg_soil , 'w') as f :
    for line in rfg_soil :
        f.write(line + '\n')

with open("C:/Users/remi.gschwind/Desktop/Resfinder FG/ResFinder_FG_Analysis/analysis0422/output/rfg_soil_seq_id.csv" , 'w') as f :
    for information in info :
        f.write(information + "\n")

#-----------ResFinder-----------#
i_rf = "C:/Users/remi.gschwind/Desktop/Resfinder FG/ResFinder_FG_Analysis/analysis0422/data/abricate.resfinder.tsv"
o_rf_soil = "C:/Users/remi.gschwind/Desktop/Resfinder FG/ResFinder_FG_Analysis/analysis0422/output/rf_soil.csv"
...
with open(i_rf , 'r') as f :
 	for line in f :
         if "resfinder" in line :
             ...
             if line.strip().split("	")[0] in soil_gene :
                  rf_soil.append(line.strip())
...
with open(o_rf_soil , 'w') as f :
    for line in rf_soil :
        f.write(line + '\n')

with open("C:/Users/remi.gschwind/Desktop/Resfinder FG/ResFinder_FG_Analysis/analysis0422/output/rf_soil_seq_id_bis.csv" , 'w') as f :
    for information in info :
        f.write(information + "\n")

#-----------ARG-ANNOT-----------#
i_arg = "C:/Users/remi.gschwind/Desktop/Resfinder FG/ResFinder_FG_Analysis/analysis0422/data/abricate.argannot.tsv"
o_arg_soil = "C:/Users/remi.gschwind/Desktop/Resfinder FG/ResFinder_FG_Analysis/analysis0422/output/arg_soil.csv"
...
print("ARG :" , x)
with open(o_arg_soil , 'w') as f :
    for line in arg_soil :
        f.write(line + '\n')

with open("C:/Users/remi.gschwind/Desktop/Resfinder FG/ResFinder_FG_Analysis/analysis0422/output/arg_soil_seq_id_bis.csv" , 'w') as f :
    for information in info :
        f.write(information + "\n")
        
#-----------CARD-----------#
i_card = "C:/Users/remi.gschwind/Desktop/Resfinder FG/ResFinder_FG_Analysis/analysis0422/data/abricate.card.tsv"
o_card_soil = "C:/Users/remi.gschwind/Desktop/Resfinder FG/ResFinder_FG_Analysis/analysis0422/output/card_soil.csv"
...
with open(o_card_soil , 'w') as f :
    for line in card_soil :
        f.write(line + '\n')

with open("C:/Users/remi.gschwind/Desktop/Resfinder FG/ResFinder_FG_Analysis/analysis0422/output/card_soil_seq_id_bis.csv" , 'w') as f :
    for information in info :
        f.write(information + "\n")
...
o_ncbi_soil = "C:/Users/remi.gschwind/Desktop/Resfinder FG/ResFinder_FG_Analysis/analysis0422/output/ncbi_soil.csv"
...
print("NCBI :" , x)
with open(o_ncbi_soil , 'w') as f :
    for line in ncbi_soil :
        f.write(line + '\n')

with open("C:/Users/remi.gschwind/Desktop/Resfinder FG/ResFinder_FG_Analysis/analysis0422/output/ncbi_soil_seq_id_bis.csv" , 'w') as f :
    for information in info :
        f.write(information + "\n")
