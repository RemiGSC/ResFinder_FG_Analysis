...
"""
#### SCRIPT DATABASE COMPARISON OF ARGs DETECTION IN GMGC GUT CATALOG ####

# First, a list of the GMGC gut catalog genes is made
i_gut = "C:/Users/remi.gschwind/Desktop/Resfinder FG/ResFinder_FG_Analysis/analysis0422/data/subcatalogs_GMGC10.human-gut.95nr.fna"

gut_gene = []
with open(i_gut , 'r') as f :
    for line in f :
        if ">" in line :
            gut_gene.append(line.strip().split(">")[1])
...
o_rfg_gut = "C:/Users/remi.gschwind/Desktop/Resfinder FG/ResFinder_FG_Analysis/analysis0422/output/rfg_gut.csv"
...
print(glycopeptide)
# ARGs found in gut_gene list and in abricate results file are pooled in a list with :
...
with open(i_rfg , 'r') as f :
 	for line in f :
         if "resfinderfg" in line :
             ...
             rfg_gut.append(line.strip())
             if line.strip().split("	")[10] in gut_gene :
                 print(gene , x)
...
with open(o_rfg_gut , 'w') as f :
    for line in rfg_gut :
        f.write(line + '\n')

with open("C:/Users/remi.gschwind/Desktop/Resfinder FG/ResFinder_FG_Analysis/analysis0422/output/rfg_gut_seq_id.csv" , 'w') as f :
    for information in info :
        f.write(information + "\n")

#-----------ResFinder-----------#
i_rf = "C:/Users/remi.gschwind/Desktop/Resfinder FG/ResFinder_FG_Analysis/analysis0422/data/abricate.resfinder.tsv"
o_rf_gut = "C:/Users/remi.gschwind/Desktop/Resfinder FG/ResFinder_FG_Analysis/analysis0422/output/rf_gut.csv"
...
with open(i_rf , 'r') as f :
 	for line in f :
         if "resfinder" in line :
             ...
             if line.strip().split("	")[0] in gut_gene :
                  rf_gut.append(line.strip())
                  print(gene , x)
                  if gene in aminocoumarin :
...
with open(o_rf_gut , 'w') as f :
    for line in rf_gut :
        f.write(line + '\n')

with open("C:/Users/remi.gschwind/Desktop/Resfinder FG/ResFinder_FG_Analysis/analysis0422/output/rf_gut_seq_id_bis.csv" , 'w') as f :
    for information in info :
        f.write(information + "\n")

#-----------ARG-ANNOT-----------#
i_arg = "C:/Users/remi.gschwind/Desktop/Resfinder FG/ResFinder_FG_Analysis/analysis0422/data/abricate.argannot.tsv"
o_arg_gut = "C:/Users/remi.gschwind/Desktop/Resfinder FG/ResFinder_FG_Analysis/analysis0422/output/arg_gut.csv"
...
print("ARG :" , x)
with open(o_arg_gut , 'w') as f :
    for line in arg_gut :
        f.write(line + '\n')

with open("C:/Users/remi.gschwind/Desktop/Resfinder FG/ResFinder_FG_Analysis/analysis0422/output/arg_gut_seq_id_bis.csv" , 'w') as f :
    for information in info :
        f.write(information + "\n")
        
#-----------CARD-----------#
i_card = "C:/Users/remi.gschwind/Desktop/Resfinder FG/ResFinder_FG_Analysis/analysis0422/data/abricate.card.tsv"
o_card_gut = "C:/Users/remi.gschwind/Desktop/Resfinder FG/ResFinder_FG_Analysis/analysis0422/output/card_gut.csv"
...
with open(o_card_gut , 'w') as f :
    for line in card_gut :
        f.write(line + '\n')

with open("C:/Users/remi.gschwind/Desktop/Resfinder FG/ResFinder_FG_Analysis/analysis0422/output/card_gut_seq_id_bis.csv" , 'w') as f :
    for information in info :
        f.write(information + "\n")
...
o_ncbi_gut = "C:/Users/remi.gschwind/Desktop/Resfinder FG/ResFinder_FG_Analysis/analysis0422/output/ncbi_gut.csv"
...
print("NCBI :" , x)
with open(o_ncbi_gut , 'w') as f :
    for line in ncbi_gut :
        f.write(line + '\n')

with open("C:/Users/remi.gschwind/Desktop/Resfinder FG/ResFinder_FG_Analysis/analysis0422/output/ncbi_gut_seq_id_bis.csv" , 'w') as f :
    for information in info :
        f.write(information + "\n")
