---
title: "Réalisation de l'upset plot pour les ARGs de GMGC water"
...
```{r}
all_data <- read.csv("C:\\Users\\remi.gschwind\\Desktop\\Resfinder FG\\ResFinder_FG_Analysis\\analysis0422\\output\\water\\all_water.csv", sep = ";")
...
df2
write.csv(df2, "C:\\Users\\remi.gschwind\\Desktop\\Resfinder FG\\ResFinder_FG_Analysis\\analysis0422\\output\\dataframe_water.csv", row.names = FALSE)
```
...
Ici : Multidrug_efflux, Cycline, Rifampicin, Peptide, Béta-lactamase et aminoside.
