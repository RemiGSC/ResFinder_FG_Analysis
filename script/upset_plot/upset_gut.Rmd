...
```{r}
all_data <- read.csv("C:\\Users\\remi.gschwind\\Desktop\\Resfinder FG\\ResFinder_FG_Analysis\\analysis0422\\output\\Gut\\hits_gut_all.csv", sep = ";")
...
```
On selectionne les 6 familles les plus représentés en complétant avec toutes les familles de RFG qui 
doivent toutes apparaître.
Ici : Multidrug_efflux, Glycopeptide/Cycloserine, Sulfonamide/Trimethoprim, MLS, aminoside, béta-lactamase, phenicol, quinolone et cycline.
